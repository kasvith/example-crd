...
import (
	"context"
	mygroupv1beta1 "github.com/kasvith/example-crd/pkg/apis/mygroup/v1beta1"
...
// Add creates a new MyKind Controller and adds it to the Manager with default RBAC. The Manager will set fields on the Controller
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to MyKind
	err = c.Watch(&source.Kind{Type: &mygroupv1beta1.MyKind{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create
	// Uncomment watch a Deployment created by MyKind - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &mygroupv1beta1.MyKind{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileMyKind) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &mygroupv1beta1.MyKind{}
	...
	log.Info("Actions are applied in controller")
